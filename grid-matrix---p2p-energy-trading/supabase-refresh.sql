-- ====================================
-- GridMatrix — REFRESH SEED DATA
-- Run this in Supabase SQL Editor to wipe old data + re-seed
-- ====================================
...
-- Marketplace listings (realistic ETH/kWh prices)
-- Using real Hardhat test addresses so MetaMask ETH transfers actually work
...
('buy',    '0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266', '0x70997970C51812dc3A010C7d01b50e0d17dc79C8', 'Rajesh Rooftop Solar',  '55 kWh Solar',   '-0.0231 ETH', 'confirmed', now() - interval '5 days 6 hours'),
